...
const Projects = () => {
    ...
    return (
        <div id='projects' className='z-1 '>
            ...
            <div ref={scrollContainerRef} className='flex md:mx-[90px] mt-[24px] md:mt-[32px] gap-[32px] overflow-x-auto flex-nowrap [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]'>
            ...
            <div className='flex mt-[38px] justify-between items-center'>
                <div className={`${Gilroy.className} md:text-[44px] text-[32px] md:ml-[40px]`}>Web Designs</div>
            ...
            <div ref={scrollContainerRef} className='flex md:mx-[90px] md:mt-[32px] gap-[18px] overflow-x-auto flex-nowrap [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]'>
                <div className='shrink-0 w-[48%] h-fit backdrop-blur-md border border-white/50 md:rounded-[19px] p-[12px] flex items-center text-white md:gap-5 '>
                    <img src="Bmw.svg" alt="Bmw" className=' md:w-full' />
                    <div>
                        <div className='flex justify-between'>
                            <div className='md:text-[24px] font-semibold'>A Premium Car Web Design</div>
                        </div>
                ...
                <div className='shrink-0 w-[48%] h-fit backdrop-blur-md border border-white/50 md:rounded-[19px] p-[12px] flex items-center text-white md:gap-5 '>
                    ...
                    <div>
                        ...
                        <div className='flex justify-between items-center'>
                            ...
                            <a href='https://www.figma.com/design/UloorFq3x9zOvJUMw85nus/Figma-work?node-id=182-553&t=gb3cDCkQL20JmATY-1' target="_blank" className='flex gap-2 text-white/80 border rounded-full p-1 pl-3 bg-black'>
                                <div>Visit me</div>
                                <img src='figmaproj.svg' alt='githubicon' className='w-[24px]' />
                            </a>
                        </div>
