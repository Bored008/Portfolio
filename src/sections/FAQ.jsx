  ...
  return (
    <div className='text-white md:flex md:gap-[120px] md:px-[126px] z-1' id='faq'>
      ...
      <div className='flex flex-col md:w-1/2 gap-y-3'>
        {faqs.map((faq, index) => (
          <div key={index} onClick={() => toggleQuestion(index)} className={`flex flex-col cursor-pointer backdrop-blur-md border border-white/50 md:px-[19px] mx-[30px] md:mx-0 md:py-[14px] px-2 p-2 md:rounded-2xl rounded-xl
